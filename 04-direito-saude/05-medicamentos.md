...
O SUS oferece medicamentos gratuitos para diversas doenças. Existem três formas principais de conseguir remédios de graça: pela Farmacia Popular, pelas farmacias das UBS e pelo programa de medicamentos de alto custo. Este guia explica cada uma delas.
...
|----------------------|----------|
| Hipertensao (pressao alta) | Remédios para pressao |
| Diabetes | Insulina e outros |
| Asma | Bombinha e outros |
| Osteoporose | Remédios para os ossos |
| Colesterol alto | Remédios para colesterol |
| Rinite | Remédios para alergia nasal |
| Doença de Parkinson | Remédios específicos |
| Glaucoma | Colirios |
| Diabetes com doenças do coração | Tratamento combinado |
...
A RENAME (Relacao Nacional de Medicamentos Essenciais) é a lista oficial de medicamentos que o SUS deve fornecer gratuitamente. Esses remédios são distribuidos diretamente nas farmacias das UBS e unidades de saúde.
...
> **Se o medicamento não estiver disponível na UBS**, pergunte quando vai chegar ou se ha outra unidade próxima com estoque. Você também pode reclamar na Ouvidoria (Disque 136).
...
O Componente Especializado da Assistência Farmaceutica (CEAF) é o programa que fornece medicamentos caros para doenças específicas. São remédios que custam caro é que a maioria das pessoas não conseguiria comprar.

### Passo a passo para solicitar no DF

**Passo 1 — Peca ao médico a documentação**

Solicite ao seu médico:
- Laudo médico detalhado com o código da doença (CID), histórico e motivo para usar o medicamento
- Receita médica com o nome completo do remédio, dose e tempo de uso
...
Um médico especialista da SES-DF vai analisar se você atende aos critérios do protocolo clinico. Prazo de resposta: até cerca de 30 dias.
...
1. **Laudo médico** mostrando que o medicamento é necessário é que os remédios fornecidos pelo SUS não funcionam para o seu caso
